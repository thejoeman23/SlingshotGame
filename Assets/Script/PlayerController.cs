...
public class PlayerController : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        {
            rb2d.linearVelocity += Vector2.up * Physics2D.gravity.y * (fallMultiplier - 1) * Time.deltaTime; // The - 1 is accounting for the physics systems normal gravity
        }
    ...
    void RememberJump()
    {
        ...
        if (Input.GetButtonUp("Jump"))
        {
            if (rb2d.linearVelocity.y > 0)
            {
                rb2d.linearVelocity = new Vector2(rb2d.linearVelocity.x, rb2d.linearVelocity.y * fCutJumpHeight);
            }
        }
